...
![1e+2+2](./images/1.png "1e+2+2")

- *Результат выражения 1e+2+2*

![1e+2+2](./images/2.png "1e+2+2")

- *Выражение sin(x), где x = 1*

![sin(x)](./images/3.png "sin(x)")

- *Результат выражения sin(x), где x = 1*

![sin(x)](./images/4.png "sin(x)")

- *Графика sin(x)*

![sin(x)](./images/5.png "sin(x)")

- *Кредит аннуитетный*

![Кредит аннуитетный](./images/6.png "Кредит аннуитетный")

- *Кредит дифференцированный*

![Кредит дифференцированный](./images/7.png "Кредит дифференцированный")

- *Депозит без капиталицзации*

![Депозит без капиталицзации](./images/8.png "Депозит без капиталицзации")

- *Депозит с капитализацией*

![Депозит с капитализацией](./images/9.png "Депозит с капитализацией")

- *Депозит с пополнением в течение срока*

![Депозит с пополнением в течение срока](./images/10.png "Депозит с пополнением в течение срока")

- *Депозит с пополнением и снятием в течение срока*

![Депозит с пополнением и снятием в течение срока](./images/11.png "Депозит с пополнением и снятием в течение срока")
